    ...
    public class DeviceValidationService : IDeviceValidationService
    {
        ...
        public async Task<bool> Validation(DiagnosisSubmissionParameter param, DateTimeOffset requestTime)
        {
            ...
            switch (param.Platform)
            {
                ...
                case "ios":
                    return await ValidationApple(param, requestTime, app);
            }
            return false;
        }
        ...
        /// </remarks>
        public async Task<bool> ValidationApple(DiagnosisSubmissionParameter param, DateTimeOffset requestTime, AuthorizedApp app)
        {
