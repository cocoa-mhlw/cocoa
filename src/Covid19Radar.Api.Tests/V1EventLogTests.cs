...
namespace Covid19Radar.Api.Tests
{
    ...
    public class V1EventLogTests
    {
        ...
        [DataRow(false, false, "250", "eventlog_submission_parameter1.json", HttpStatusCode.Forbidden, 0)]
        [DataRow(true, false, "250", "eventlog_submission_parameter1.json", HttpStatusCode.BadRequest, 0)]
        [DataRow(false, true, "250", "eventlog_submission_parameter1.json", HttpStatusCode.Forbidden, 0)]
