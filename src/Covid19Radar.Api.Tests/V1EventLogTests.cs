...
namespace Covid19Radar.Api.Tests
{
    ...
    public class V1EventLogTests
    {
        ...
        [DataRow(true, true, "250", "eventlog_submission_parameter1.json", HttpStatusCode.Created, 4)]
        [DataRow(true, true, NOT_OVER_LIMIT_CONTENT_LENGTH, "eventlog_submission_parameter1.json", HttpStatusCode.Created, 4)]
