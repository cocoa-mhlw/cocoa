...
![ENv1とv2の接触判定の違い](/cocoa/appendix/fig1.png)
...
![設計すべきリスクスコアの形](/cocoa/appendix/fig2.png)
...
![距離別の、その電波強度になる可能性の分布](/cocoa/appendix/fig3.png)
...
![電波強度を多数測定することによる確率分布の変化](/cocoa/appendix/fig4.png)
...
![距離別の電波強度の分布](/cocoa/appendix/fig5.png)
...
![パラメータ設計のための実機計測結果](/cocoa/appendix/fig6.png)
...
![電波強度別の重み付けを変える効果（イメージ）](/cocoa/appendix/fig7.png)
...
![距離別の電波強度の分布の活用イメージ](/cocoa/appendix/fig8.png)
...
![パラメータ値(Attenuation, Weight, 閾値)当初案](/cocoa/appendix/fig9.png)
...
![パラメータ検証のための実機計測結果](/cocoa/appendix/fig10.png)
...
![パラメータ値(Attenuation, Weight, 閾値)修正後](/cocoa/appendix/fig11.png)
