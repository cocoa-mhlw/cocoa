...
namespace Covid19Radar.Common
{
    ...
    {
        public static readonly string AppCenterTokensAndroid = "android=AppIdForAndroidPlaceholder;";
        public static readonly string AppCenterTokensIOS = "ios=AppIdForiOSPlaceholder;";
		/// <summary>
		/// Start Transmit
		/// </summary>
