...
namespace Covid19Radar.ViewModels
{
    public class TermsofservicePageViewModel : ViewModelBase
    {
        ...
        public TermsofservicePageViewModel(INavigationService navigationService, UserDataService userDataService, ExposureNotificationService exposureNotificationService) : base(navigationService, userDataService, exposureNotificationService)
        {
