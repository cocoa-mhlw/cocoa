...
namespace Covid19Radar.ViewModels
{
    public class NotifyOtherPageViewModel : ViewModelBase
    {
        ...
        public Command OnClickRegister => (new Command(async () =>
        {
            ...
            var result = await UserDialogs.Instance.ConfirmAsync(AppResources.NotifyOtherPageDiag1Message, AppResources.NotifyOtherPageDiag1Title, AppResources.ButtonOk, AppResources.ButtonCancel);
            if (!result)
            {
