...
namespace CovidRadar.UITestV2
{
    ...
    public class TutorialPageFlow
    {
        ...
        public void Tutorial()
        {
            ...
            EventLogCooperationPage eventLogCooperationPage = tutorialPage4.OpenEventLogCooperationPage();
            eventLogCooperationPage.AssertEventLogCooperationPage();

            EventLogSettingPage eventLogSettingPage = eventLogCooperationPage.OpenEventLogSettingPage();
            eventLogSettingPage.AssertEventLogSettingPage();
            eventLogSettingPage.TapCheckBox();
            eventLogSettingPage.OpenTutorialPage6();
            
            TutorialPage6 tutorialPage6 = eventLogSettingPage.TaplDialogOKBtn();
