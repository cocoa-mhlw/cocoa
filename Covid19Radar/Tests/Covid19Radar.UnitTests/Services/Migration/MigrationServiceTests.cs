...
namespace Covid19Radar.UnitTests.Services.Migration
{
    public class MigrationServiceTests
    {
        ...
        [Fact]
        public async Task Migrate_InitTo120Async()
        {
            _mockEssentialService.SetupGet(x => x.AppVersion).Returns("1.2.0");
...
>>>>>>> 5af6efe9905e25589e57a17332bc44a58c532e16
            ...
            /// However, those values are DateTime that user agreed, and for compatibility reasons, default values should not be generated by migration process.
...
>>>>>>> 5af6efe9905e25589e57a17332bc44a58c532e16
        ...
        private async Task<(DateTime, Dictionary<string, long>, UserExposureInfo, UserExposureInfo, UserExposureSummary)> SetUpVersion100(
            bool isOptIned = true,
        ...
        private async Task<(DateTime, DateTime, DateTime, Dictionary<string, long>, UserExposureInfo, UserExposureInfo, UserExposureSummary)> SetUpVersion120(
            DateTime termsOfServiceLastUpdateDateJst,
            DateTime privacyPolicyLastUpdateDateJst,
            bool isOptIned = true,
            bool isPrivaryPolicyAgreed = true,
            bool hasAppVersionAtPreference = true
        )
        {
            var (
                ...
                lastProcesTekTimestamp,
                userExposureInfo1, userExposureInfo2, userExposureSummary
            ) = await SetUpVersion100(isOptIned, isPrivaryPolicyAgreed, hasAppVersionAtPreference);
            ...
            await _dummyApplicationPropertyService.SavePropertiesAsync(
                APPLICATION_PROPERTY_TERMS_OF_SERVICE_LAST_UPDATE_DATE_KEY,
                termsOfServiceLastUpdateDateJst.ToString()
                );
            await _dummyApplicationPropertyService.SavePropertiesAsync(
                APPLICATION_PROPERTY_PRIVACY_POLICY_LAST_UPDATE_DATE_KEY,
                privacyPolicyLastUpdateDateJst.ToString()
                );
        ...
        )
        {
            var (
                startDateTime,
                termsOfServiceLastUpdateDateJst120, privacyPolicyLastUpdateDateJst120,
                lastProcesTekTimestamp,
                userExposureInfo1, userExposureInfo2, userExposureSummary
            ) = await SetUpVersion120(
                termsOfServiceLastUpdateDateJst,
                privacyPolicyLastUpdateDateJst,
                isOptIned,
                isPrivaryPolicyAgreed,
                hasAppVersionAtPreference
                );
        ...
        [Fact]
        public async Task Migrate_120to122Async()
        {
            var (
                startDateTime,
                termsOfServiceLastUpdateDateJst, privacyPolicyLastUpdateDateJst,
                ...
                termsOfServiceLastUpdateDateJst: JstNow.AddMinutes(1),
                privacyPolicyLastUpdateDateJst: JstNow.AddMinutes(2),
                hasAppVersionAtPreference: false
                );
        ...
        [Fact]
        public async Task Migrate_120to123Async()
        {
            var (
                startDateTime,
                termsOfServiceLastUpdateDateJst, privacyPolicyLastUpdateDateJst,
        ...
        [Fact]
        public async Task Migrate_120to130Async()
        {
            var (
                startDateTime,
                termsOfServiceLastUpdateDateJst, privacyPolicyLastUpdateDateJst,
                ...
                hasAppVersionAtPreference: false,
                termsOfServiceLastUpdateDateJst: JstToUtc(DateTime.UtcNow).AddMinutes(1),
                privacyPolicyLastUpdateDateJst: JstToUtc(DateTime.UtcNow).AddMinutes(2)
            );
        ...
        public async Task Migrate_122to130Async()
        {
            var (
                ...
                hasAppVersionAtPreference: false,
                termsOfServiceLastUpdateDateJst: JstToUtc(DateTime.UtcNow),
                privacyPolicyLastUpdateDateJst: JstToUtc(DateTime.UtcNow)
            );
        ...
        {
            var values = await SetUpVersion122(
                isOptIned: isOptIned,
                termsOfServiceLastUpdateDateJst: termsOfServiceLastUpdateDateJst,
                isPrivaryPolicyAgreed: isPrivaryPolicyAgreed,
                privacyPolicyLastUpdateDateJst: privacyPolicyLastUpdateDateJst,
                hasAppVersionAtPreference: hasAppVersionAtPreference
                );
